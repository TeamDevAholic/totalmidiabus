...
<div class="container  bg-light text-center" style="margin-top: 5%;">
  ...
  <div style=" margin-left:73%; margin-top: -5%;">
    <a class="btn btn-hero btn-primary" href="/editar_setor/{{$setor->id}}" data-toggle="click-ripple">
      <i class="fa fa-pencil-alt"></i>
    </a>
    <a class="btn btn-hero btn-primary" href="#" onclick="confirmarEliminar({{$setor->id}})" data-toggle="click-ripple">
      <i class="fa fa-trash"></i>
  </a>
    <a class="btn  btn-hero btn-primary my-2" href="/setores">
    ...
    <div class="col-md-3">
      ...
      <div class="card card-primary card-outline">
        <div class="card-body box-profile">
          ...
          <h3 class="profile-username text-center">{{ $setor->nome }}</h3>

          <p class="text-muted text-center">{{ $setor->complemento }}</p>

          <ul class="list-group list-group-unbordered mb-3">
            <li class="list-group-item">
              <b>Preço: </b> {{ $setor->preco }}
            </li>
            <li class="list-group-item">
              <b>Descrição: </b> {{ $setor->descricao }}
            </li>
          </ul>

          <a href="/editar_setor/{{$setor->id}}" class="btn btn-primary btn-block"><b>Editar</b></a>
        </div>
        <!-- /.card-body -->
      </div>
      <!-- /.card -->
      ...
      <div class="card card-primary">
        <div class="card-header">
          <h5 class="card-title">Mais informações do setor</h5>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          ...
          <p class="text-muted">{{ $setor->descricao }}</p>
            ...
            <div class="tab-pane" id="settings">
                ...
                <div class="row">
                  <div class="col-lg-8 space-y-2">
                      ...
                      <form action="/actualizar_setor/{{$setor->id}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-4 col-9 inline-block">
                          <label class="form-label" for="nome">Nome do setor</label>
                          <input type="text" class="form-control" id="nome" required name="nome" value="{{$setor->nome}}">
                        </div>

                        <div class="mb-4 col-9 inline-block complemento">
                            <label class="form-label" for="preco">Preço</label>
                            <input type="text" class="form-control" id="preco" name="preco" value="{{$setor->preco ?? ''}}">
                        </div>
                        <div class="mb-4 col-9 inline-block complemento">
                            <label class="form-label" for="descricao">Descrição</label>
                            <textarea name="descricao" class="form-control" id="descricao" cols="10" style="resize: none;" rows="5">{{$setor->descricao}}</textarea>
                        </div>
...
<script>
   function confirmarEliminar(setorId) {
        Swal.fire({
            title: 'Confirmar Eliminar',
            text: 'Tem certeza de que deseja eliminar este setor?',
            icon: 'warning',
