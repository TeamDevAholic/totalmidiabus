            ...
            <div class="block-content">
              <div class="row justify-content-center">
                <div class="col-md-12 col-lg-10">
                  <form action="/salvar_vendapi3" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4 col-8 inline-block">
                      ...
                      <div class="mb-4 col-8 inline-block">
                        ...
                        <input type="hidden" name="status" value="VENDA CONCLUIDA,  AGUARDAR APENAS A DATA DE PAGAMENTO PARA FECHAR O CICLO E DAR ENTRADA">
                        <div class="mb-4">
