                ...
                <div class="bg-body-light">
                  <div class="content content-full">
                    <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                      <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Venda P.I 2</h1>

                    </div>
                    <h5>Status <span class="badge bg-warning">Aguardando faturamento</span></h5>
                  </div>
                </div>
                <!-- END Hero -->
                  ...
                  <form action="/salvar_vendapi2" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4 col-8 inline-block">
                      ...
                      <div class="mb-4 col-8 inline-block">
                        ...
                        <input type="hidden" name="status" value="Aguardando faturamento">
                        <div class="mb-4">
