...
<div class="container  bg-light text-center" style="margin-top: 5%;">
  ...
  <div style=" margin-left:73%; margin-top: -5%;">
    <a class="btn btn-hero btn-primary" href="/editar_empresa/{{$empresa->id}}" data-toggle="click-ripple">
      <i class="fa fa-pencil-alt"></i>
    </a>
    <a class="btn btn-hero btn-primary" href="#" onclick="confirmarApagar({{$empresa->id}})" data-toggle="click-ripple">
      <i class="fa fa-trash"></i>
  </a>
    <a class="btn  btn-hero btn-primary my-2" href="/empresas">
    ...
    <div class="col-md-3">
      ...
      <div class="card card-primary card-outline">
        <div class="card-body box-profile">
          ...
          <p class="text-muted text-center">{{ $empresa->descricao }}</p>



          <a href="/editar_empresa/{{$empresa->id}}" class="btn btn-primary btn-block"><b>Editar</b></a>
        </div>
        <!-- /.card-body -->
      </div>
      <!-- /.card -->
      ...
      <div class="card card-primary">
        <div class="card-header">
          <h5 class="card-title">Mais informações da empresa</h5>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <strong>Logomarca</strong>

            <img src="{{ $empresa->logomarca }}" width="210" alt="LOGOMARCA">
            ...
            <div class="tab-pane" id="settings">
                ...
                <div class="row">
                  <div class="col-lg-8 space-y-2">
                      ...
                      <form class="row" action="/actualizar_empresa/{{$empresa->id}}" method="POST" enctype="multipart/form-data">
                          @csrf <!-- CSRF token -->
                          ...
                          <div class="col-md-9">
                              ...
                              <div class="form-group mb-2">
                                  ...
                                  <input type="text" value="{{ $empresa->nome }}" class="form-control form-control-lg" id="example-if-email2" name="nome" placeholder="Nome">
                              </div>

                              <!-- Email input -->
                              <div class="form-group mb-2">
                                <label for="example-if-email2">Descrição</label>
                                <textarea name="descricao" class="form-control" id="descricao" cols="10" rows="5" style="resize: none;">{{ $empresa->descricao }}</textarea>
                              </div>
                              <div class="form-group mb-2">
                                <label for="example-if-email2">Logomarca</label>
                                <input type="file" value="{{ $empresa->logomarca }}" name="logomarca" class="form-control" id="logomarca">
                              </div>
