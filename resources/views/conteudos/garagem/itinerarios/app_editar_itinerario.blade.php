        ...
        <div class="bg-body-light">
          ...
          <div class="block block-rounded">
            <div class="block-header block-header-default">
              <h3 class="block-title">Editar Itinerario</h3>
            </div>
                            ...
                            <form class="row" action="/actualizar_itinerario/{{$itinerario->id}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group mb-2">
                                        <label for="example-if-email2">Nome do itinerario</label>
                                        <input type="text" value="{{ $itinerario->nome }}" class="form-control form-control-lg" id="example-if-email2" name="nome" placeholder="Nome">
                                    </div>

                                    <!-- Descrição input -->
                                    <div class="form-group mb-2">
                                        <label for="example-if-email2">Linha</label>
